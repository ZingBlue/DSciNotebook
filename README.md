...
This repository is a report and analysis of perceptions of AI prior to the introduction of generative AI.

Primary data set: <https://github.com/AdaLovelaceInstitute/how-do-people-feel-about-ai>

## Description and Goals

This project will explore demographic and experiential differences in attitudes toward AI, produce summary visualizations, and prepare the data set for later modelling (e.g., subgroup comparisons and regression). To view the report, see the exploratory analysis notebook: [EDA-Notebook.html](./EDA-Notebook.html).
